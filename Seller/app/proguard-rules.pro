...
-keep class [cn.cloudworkshop.seller].** {*;}
-keep class cn.cloudworkshop.seller.bean.**{*;}

-keep class cn.cloudworkshop.seller.utils.GsonUtils{*;}
...
-keep public class [cn.cloudworkshop.seller].R$*{
